...
public:
    ...
    QPushButton *ImageStartButton;
    QPushButton *ImageStopButton;
    QMenuBar *menubar;
    QMenu *menu_File;
    QMenu *menuViw;
    ...
    void setupUi(QMainWindow *MainWindowDesign)
    {
        ...
        actionShow_status = new QAction(MainWindowDesign);
        actionShow_status->setObjectName(QString::fromUtf8("actionShow_status"));
        ...
        imageLable = new QLabel(groupBox_12);
        imageLable->setObjectName(QString::fromUtf8("imageLable"));
        imageLable->setMinimumSize(QSize(0, 350));

        verticalLayout_4->addWidget(imageLable);

        widget = new QWidget(groupBox_12);
        widget->setObjectName(QString::fromUtf8("widget"));
        horizontalLayout = new QHBoxLayout(widget);
        horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
        ImageStartButton = new QPushButton(widget);
        ImageStartButton->setObjectName(QString::fromUtf8("ImageStartButton"));

        horizontalLayout->addWidget(ImageStartButton);

        ImageStopButton = new QPushButton(widget);
        ImageStopButton->setObjectName(QString::fromUtf8("ImageStopButton"));

        horizontalLayout->addWidget(ImageStopButton);
        ...
        menuViw->addAction(actionShow_status);
    ...
    void retranslateUi(QMainWindow *MainWindowDesign)
    {
        ...
        actionShow_status->setText(QApplication::translate("MainWindowDesign", "Show status", 0, QApplication::UnicodeUTF8));
        groupBox_12->setTitle(QApplication::translate("MainWindowDesign", "Logging", 0, QApplication::UnicodeUTF8));
        imageLable->setText(QApplication::translate("MainWindowDesign", "ShowImage", 0, QApplication::UnicodeUTF8));
        ImageStartButton->setText(QApplication::translate("MainWindowDesign", "start", 0, QApplication::UnicodeUTF8));
        ImageStopButton->setText(QApplication::translate("MainWindowDesign", "stop", 0, QApplication::UnicodeUTF8));
        tab_manager->setTabText(tab_manager->indexOf(tab_status), QApplication::translate("MainWindowDesign", "Ros GelSight", 0, QApplication::UnicodeUTF8));
        menu_File->setTitle(QApplication::translate("MainWindowDesign", "&App", 0, QApplication::UnicodeUTF8));
        menuViw->setTitle(QApplication::translate("MainWindowDesign", "View", 0, QApplication::UnicodeUTF8));
