...
void readHandData(std::vector<std::vector<double>> &hand_data){
    std::ifstream csv_data("/home/xgy/XGY/xgy_data/xgy_0509_data/csv/hand_02.csv", std::ios::in);
    std::string line;
...
void readGelsightData(std::vector<double> &gelsight_data){
    std::ifstream csv_data("/home/xgy/XGY/xgy_data/xgy_0509_data/csv/gelsight_02.csv", std::ios::in);
    std::string line;
...
int main()
{
    ...
    std::ofstream ofs;
    ofs.open("/home/xgy/XGY/xgy_data/xgy_0509_data/csv/sync.csv",std::ios::out|std::ios::app);
